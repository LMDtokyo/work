...
namespace MessagingPlatform.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260208150000_AddFKsAndTokenEncrypt")]
    partial class AddFKsAndTokenEncrypt
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MessagingPlatform.Domain.Entities.Message", b =>
                {
                    ...
                    b.Property<string>("WbMessageId")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("wb_message_id");
                    ...
                    b.HasIndex("WbMessageId")
                        .IsUnique()
                        .HasDatabaseName("ix_messages_wb_message_id");
            ...
            modelBuilder.Entity("MessagingPlatform.Domain.Entities.WbAccount", b =>
                {
                    ...
                    b.Property<string>("LastEventCursor")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)")
