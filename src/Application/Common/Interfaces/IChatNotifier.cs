...
public interface IChatNotifier
{
    ...
    Task NotifyNewOrder(Guid userId, Guid orderId, string? productName, decimal price, string status);
    Task NotifySyncDone(Guid userId, int orderCount, int chatCount);
}
