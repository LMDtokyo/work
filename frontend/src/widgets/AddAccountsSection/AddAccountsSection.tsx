...
function AddAccountsSection() {
  ...
  return (
    <div className="flex flex-col gap-4 bg-chat-secondary-bg w-full rounded-3xl border border-chat-primary-border py-6 px-10 animate-fade-in-bottom">
      ...
      <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
        <AccountSlider />
        <button className="bg-contrast rounded-full w-full py-3 text-tertiary-font cursor-pointer hover:scale-101 duration-100">
          Добавить
        </button>
      </form>
    </div>
