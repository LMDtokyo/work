...
function BackButton({ className = "", link }: IBackButton) {
  ...
  const cls = cx(
    "flex gap-1 bg-auth-secondary-bg px-4 py-1 rounded-full outline-none font-semibold text-primary-font shadow-[0_2px_4px_#00000025] cursor-pointer hover:shadow-[0_3px_6px_#00000030] duration-150",
    className,
  );
