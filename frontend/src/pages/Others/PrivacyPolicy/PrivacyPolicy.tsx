export const PrivacyPolicy = () => {
  return (
    <div className="text-font-primary bg-auth-bg w-full h-full py-5 px-24 pb-20 overflow-hidden">
      <br />
      <h1 className="text-center text-4xl font-bold px-48">
      ...
      <br />
      <p className="text-font-contrast font-semibold text-md text-center text-lg px-48">
      ...
      <div className="flex flex-col gap-2 text-lg">
        <p>
          <span className="text-font-contrast font-semibold">1.1.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">1.2.</span>{" "}
          ...
          <a
            ...
            className="text-font-contrast font-semibold"
          >
            https://manitocrm.ru
          </a>
          .
        ...
        <p>
          <span className="text-font-contrast font-semibold">1.3.</span> В
          рамках настоящей Политики под персональной информацией Пользователя
          понимаются:
        </p>
        <p>
          <span className="text-font-contrast font-semibold">1.3.1.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">1.3.2.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">1.3.3.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">1.3.4.</span>{" "}
      ...
      <div className="flex flex-col gap-2 text-lg">
        <p>
          <span className="text-font-contrast font-semibold">1.4.1.</span>{" "}
          Автоматизированная обработка персональных данных – обработка
          персональных данных с помощью средств вычислительной техники.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">1.4.2.</span>{" "}
          Блокирование персональных данных – временное прекращение обработки
          персональных данных (за исключением случаев, если обработка необходима
          для уточнения персональных данных).
        </p>
        <p>
          <span className="text-font-contrast font-semibold">1.4.3.</span> Сайт
          и электронная Платформа – совокупность графических и информационных
        ...
        <p>
          <span className="text-font-contrast font-semibold">1.4.4.</span>{" "}
          Информационная система персональных данных — совокупность содержащихся
          в базах данных персональных данных, и обеспечивающих их обработку
          информационных технологий и технических средств.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">1.4.5.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">1.4.6.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">1.4.7.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">1.4.8.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">1.4.9.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">1.4.10.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">1.4.11.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">1.4.12.</span>{" "}
      ...
      <div className="flex flex-col gap-2 text-lg">
        <p>
          <span className="text-font-contrast font-semibold">2.1.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">2.2.</span>{" "}
          Персональную информацию Пользователя Сайт/Платформа обрабатывает в
          следующих целях:
        </p>
        <p>
          <span className="text-font-contrast font-semibold">2.2.1.</span>{" "}
          Идентификации Пользователя, зарегистрированного на Сайте/Платформе,
          для возможности вступить в договорные отношения.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">2.2.2.</span>{" "}
          Предоставления Пользователю доступа к персонализированным ресурсам
          Сайта/Платформы.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">2.2.3.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">2.2.8.</span>{" "}
          Создания учетной записи для Пользователя, если Пользователь дал
          согласие на создание учетной записи.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">2.2.9.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">2.3.</span> Также
        ...
        <p>
          <span className="text-font-contrast font-semibold">2.4.</span>{" "}
      ...
      <div className="flex flex-col gap-2 text-lg">
        <p>
          <span className="text-font-contrast font-semibold">3.1.</span>{" "}
          Сайт/Платформа хранит персональную информацию Пользователей в
          соответствии с внутренними регламентами конкретных сервисов.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">3.2.</span> В
          отношении персональной информации Пользователя сохраняется ее
        ...
        <p>
          <span className="text-font-contrast font-semibold">3.3.</span> Сайт
          вправе передать персональную информацию Пользователя третьим лицам в
          следующих случаях:
        </p>
        <p>
          <span className="text-font-contrast font-semibold">3.3.1.</span>{" "}
          Пользователь выразил согласие на такие действия.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">3.3.2.</span>{" "}
          Передача необходима для использования Пользователем определенного
          сервиса либо для исполнения определенного соглашения или договора с
          Пользователем.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">3.3.3.</span>{" "}
          Передача необходима в рамках использования Пользователем
          Сайта/Платформы для передачи информации третьим лицам (например,
          платежным системам).
        </p>
        <p>
          <span className="text-font-contrast font-semibold">3.3.4.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">3.3.5.</span> В
          случае продажи Сайта/Платформы к приобретателю переходят все
          обязательства по соблюдению условий настоящей Политики применительно к
          полученной им персональной информации.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">3.4.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">3.5.</span> При
          утрате или разглашении персональных данных Оператор информирует
          Пользователя об утрате или разглашении персональных данных.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">3.6.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">3.7.</span>{" "}
      ...
      <div className="flex flex-col gap-2 text-lg">
        <p>
          <span className="text-font-contrast font-semibold">4.1.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">4.2.</span>{" "}
          Оператор обрабатывает персональные данные Пользователя только в случае
          их заполнения и/или отправки Пользователем самостоятельно через
          специальные формы, расположенные на сайте:{" "}
          <a
        ...
        <p>
          <span className="text-font-contrast font-semibold">4.3.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">4.4.</span> Субъект
      ...
      <div className="flex flex-col gap-2 text-lg">
        <p>
          <span className="text-font-contrast font-semibold">5.1.</span>{" "}
          Обработка персональных данных осуществляется на законной и
          справедливой основе.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">5.2.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">5.3.</span> Не
        ...
        <p>
          <span className="text-font-contrast font-semibold">5.4.</span>{" "}
          Обработке подлежат только персональные данные, которые отвечают целям
          их обработки.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">5.5.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">5.6.</span> При
        ...
        <p>
          <span className="text-font-contrast font-semibold">5.7.</span>{" "}
      ...
      <div className="flex flex-col gap-2 text-lg">
        <p>
          <span className="text-font-contrast font-semibold">6.1.</span>{" "}
          ...
          технических мер, необходимых для выполнения в полном объеме требования
          действующего законодательства в области защиты персональных данных.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">6.2.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">6.3.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">6.4.</span> В
        ...
        <p>
          <span className="text-font-contrast font-semibold">6.5.</span> Срок
        ...
        <p>
          <span className="text-font-contrast font-semibold">6.6.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">6.7.</span> Вся
        ...
        <p>
          <span className="text-font-contrast font-semibold">6.8.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">6.9.</span>{" "}
          Оператор при обработке персональных данных обеспечивает
          конфиденциальность персональных данных.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">6.10.</span>{" "}
          ...
          является Пользователь/субъект персональных данных.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">6.11.</span>{" "}
          ...
          действия согласия Пользователя/субъекта персональных данных или отзыв
      ...
      <div className="flex flex-col gap-2 text-lg">
        <p>
          <span className="text-font-contrast font-semibold">7.1.1.</span>{" "}
          Получать от Пользователя/субъекта персональных данных достоверные
          информацию и/или документы, содержащие персональные данные;
        </p>
        <p>
          <span className="text-font-contrast font-semibold">7.1.2.</span> В
        ...
        <p>
          <span className="text-font-contrast font-semibold">7.1.3.</span>{" "}
      ...
      <div className="flex flex-col gap-2 text-lg">
        <p>
          <span className="text-font-contrast font-semibold">7.2.1.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">7.2.2.</span>{" "}
          Организовывать обработку персональных данных в порядке, установленном
          действующим законодательством РФ;
        </p>
        <p>
          <span className="text-font-contrast font-semibold">7.2.3.</span>{" "}
          Отвечать на обращения и запросы Пользователей/субъектов персональных
          данных и их законных представителей в соответствии с требованиями
          Закона о персональных данных;
        </p>
        <p>
          <span className="text-font-contrast font-semibold">7.2.4.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">7.2.5.</span>{" "}
          Публиковать или иным образом обеспечивать неограниченный доступ к
          настоящей Политике конфиденциальности;
        </p>
        <p>
          <span className="text-font-contrast font-semibold">7.2.6.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">7.2.7.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">7.2.8.</span>{" "}
      ...
      <div className="flex flex-col gap-2 text-lg">
        <p>
          <span className="text-font-contrast font-semibold">7.3.1.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">7.3.2.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">7.3.3.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">7.3.4.</span> На
          отзыв согласия на обработку персональных данных;
        </p>
        <p>
          <span className="text-font-contrast font-semibold">7.3.5.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">7.3.6.</span> На
      ...
      <div className="flex flex-col gap-2 text-lg">
        <p>
          <span className="text-font-contrast font-semibold">7.4.1.</span>{" "}
          Предоставлять Оператору достоверные данные о себе;
        </p>
        <p>
          <span className="text-font-contrast font-semibold">7.4.2.</span>{" "}
          Сообщать Оператору об уточнении (обновлении, изменении) своих
          персональных данных.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">7.5.</span> Лица,
      ...
      <div className="flex flex-col gap-2 text-lg">
        <p>
          <span className="text-font-contrast font-semibold">8.1.</span>{" "}
          Оператор может обрабатывать следующие персональные данные Пользователя
        </p>
        <p>
          <span className="text-font-contrast font-semibold">8.1.1.</span>{" "}
          Фамилия, имя, отчество.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">8.1.2.</span>{" "}
          Электронный адрес.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">8.1.3.</span>{" "}
          Номера телефонов.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">8.2.</span> Также
          ...
          (Яндекс Метрика и Гугл Аналитика и других). Вышеперечисленные данные
          далее по тексту Политики объединены общим понятием Персональные
          данные.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">8.3.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">8.4.</span>{" "}
          ...
          10 Закона о персональных данных, допускается, если соблюдаются запреты
          и условия, предусмотренные ст. 10.1 Закона о персональных данных.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">8.5.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">8.6.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">8.7.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">8.8.</span>{" "}
          ...
          адрес электронной почты) субъекта персональных данных, а также
        ...
        <p>
          <span className="text-font-contrast font-semibold">8.9.</span>{" "}
          Согласие на обработку персональных данных, разрешенных для
          распространения, прекращает свое действие с момента поступления
          Оператору требования, указанного в настоящей Политике в отношении
      ...
      <div className="flex flex-col gap-2 text-lg">
        <p>
          <span className="text-font-contrast font-semibold">9.1.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">9.2.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">9.3.</span>{" "}
        ...
        <p>
          <span className="text-font-contrast font-semibold">9.4.</span>{" "}
      ...
      <br />
      <p className="text-lg">
        <span className="text-font-contrast font-semibold">10.1.</span> Оператор
      ...
      <div className="flex flex-col gap-2 text-lg">
        <p>
          <span className="text-font-contrast font-semibold">11.1.</span>{" "}
          Оператор, не исполнивший свои обязательства, несет ответственность за
          убытки, понесенные Пользователем в связи с неправомерным
          использованием персональных данных, в соответствии с законодательством
          Российской Федерации.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">11.2.</span> В
          случае утраты или разглашения конфиденциальной информации Оператор не
          несет ответственности, если данная конфиденциальная информация:
        </p>
        <p>
          <span className="text-font-contrast font-semibold">11.2.1.</span>{" "}
          Стала публичным достоянием до ее утраты или разглашения.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">11.2.2.</span> Была
          получена от третьей стороны до момента ее получения Оператором.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">11.2.3.</span> Была
      ...
      <div className="flex flex-col gap-2 text-lg">
        <p>
          <span className="text-font-contrast font-semibold">12.1.</span> До
        ...
        <p>
          <span className="text-font-contrast font-semibold">12.2.</span>{" "}
          Получатель претензии в течение 10 календарных дней со дня получения
          претензии письменно уведомляет заявителя претензии о результатах
          рассмотрения претензии.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">12.3.</span> При
          недостижении соглашения спор будет передан на рассмотрение в суд в
          соответствии с действующим законодательством Российской Федерации.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">12.4.</span> К
          настоящей Политике конфиденциальности и отношениям между Пользователем
      ...
      <div className="flex flex-col gap-2 text-lg">
        <p>
          <span className="text-font-contrast font-semibold">13.1.</span>{" "}
          Оператор вправе вносить изменения в настоящую Политику
          конфиденциальности без согласия Пользователя.
        </p>
        <p>
          <span className="text-font-contrast font-semibold">13.2.</span> Новая
        ...
        <p>
          <span className="text-font-contrast font-semibold">13.3.</span> Все
        ...
        <p>
          <span className="text-font-contrast font-semibold">13.4.</span>{" "}
          Действующая Политика конфиденциальности и обработки персональных
          данных размещена на странице по адресу: на сайте:{" "}
          <a
