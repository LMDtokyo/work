...
export const Landing = () => {
  return (
    <div className="bg-landing-primary-bg w-full h-full px-4 sm:px-6 md:px-10 lg:px-14 relative">
      <div className="w-170 h-170 bg-glare absolute rounded-full -left-140 top-18 blur-[100px] z-0 duration-200"></div>
      <div className="w-170 h-170 bg-glare absolute rounded-full -right-140 top-18 blur-[100px] z-0 duration-200"></div>
      <LandingHeader />
      <main>
        <HeroSection />
        <PosibilitiesSection />
